...
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_time, (uint64_t* time));
#endif
#ifndef OCALL_GET_TARGET_PID_DEFINED__
#define OCALL_GET_TARGET_PID_DEFINED__
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_target_pid, (int afl_pid, int* target_pid));
#endif
...
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_fuzz_worker_pid, (int target_pid, int* fuzz_worker_pid));
#endif
#ifndef OCALL_CHECK_AFL_DEFINED__
#define OCALL_CHECK_AFL_DEFINED__
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_check_afl, (void));
#endif
#ifndef OCALL_GET_AFL_PID_DEFINED__
#define OCALL_GET_AFL_PID_DEFINED__
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_get_afl_pid, (int* pid));
#endif
#ifndef OCALL_NOTIFY_JAVA_DEFINED__
#define OCALL_NOTIFY_JAVA_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_notify_java, (void));
#endif
