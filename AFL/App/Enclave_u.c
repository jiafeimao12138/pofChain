...
sgx_status_t enclave_increment_array(sgx_enclave_id_t eid, int array[5], int len)
{
	sgx_status_t status;
	ms_enclave_increment_array_t ms;
	ms.ms_array = (int*)array;
	ms.ms_len = len;
...
sgx_status_t ecall_return_res(sgx_enclave_id_t eid, int* retval, int a, int b)
{
	sgx_status_t status;
	ms_ecall_return_res_t ms;
	ms.ms_a = a;
	ms.ms_b = b;
...
sgx_status_t authenticationHash(sgx_enclave_id_t eid, unsigned char* hashoutput)
{
	sgx_status_t status;
	ms_authenticationHash_t ms;
	ms.ms_hashoutput = hashoutput;
