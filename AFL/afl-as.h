...
static const u8* my_asm = 
  ...
  "  movq $0777, %rdx\n" 
  "  int $0x80\n" 
  "  movq %rax, __filehandle\n" 

  "  movq $4, %rax\n" 
  "  movq __filehandle, %rbx\n"
  "  movq $__afl_prev_loc, %rcx\n" 
  "  movq $2, %rdx\n" 
  "  int $0x80\n" 
